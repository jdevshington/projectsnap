        ...
        return (
            <main className="mx-auto max-w-md px-6 pt-16">
                ...
                <div className="mt-8 rounded-2xl border border-[#E2E2E0] bg-white p-6">
                    <p className="mb-1 font-medium text-[#111110]">Link expired or invalid</p>
                ...
                <p className="mt-6 text-center text-sm text-[#6F6F6C]">
                    <Link href="/forgot-password" className="font-medium text-[#111110] underline underline-offset-2">
                        Request a new link
                    </Link>
                </p>
            </main>
